...
final class FabricReflectionConstants {
    ...
    static final String M_IS_OP                = im("net.minecraft.server.players.PlayerList","isOp",                 "(Lcom/mojang/authlib/GameProfile;)Z",                          "f"); // Intermediary 'f' on 1.18.2/1.21.1.  Without this, scanMethod matches isWhiteListed (same (GameProfile)Z sig, declared first) and returns false for non-whitelisted ops.
