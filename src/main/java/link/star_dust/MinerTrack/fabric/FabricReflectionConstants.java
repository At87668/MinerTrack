...
final class FabricReflectionConstants {
    ...
    static final String M_GET_PROFILE_PERMISSIONS = im("net.minecraft.server.MinecraftServer", "getProfilePermissions", "(Lcom/mojang/authlib/GameProfile;)I",               "method_3835");
    ...
    static final String M_DISCONNECT           = im("net.minecraft.server.network.ServerGamePacketListenerImpl", "disconnect", "(Lnet/minecraft/network/chat/Component;)V",          "method_10839");
