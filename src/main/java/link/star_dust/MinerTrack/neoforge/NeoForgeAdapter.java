...
/**
 * NeoForge PluginAdapter. Mirrors FabricAdapter structurally.
 * Uses {@code net.neoforged.*} APIs for config paths and mod metadata.
 */
public class NeoForgeAdapter implements PluginAdapter {
    private final File dataFolder;
    private final YamlLoader yamlLoader = new NeoForgeYamlLoader();
    private final String version;
    private volatile Boolean debugCached = null;

    public NeoForgeAdapter() {
        Path root = NeoForgeReflection.getConfigDir();
        ...
        String v;
        try {
            v = NeoForgeReflection.getModVersion("minertrack");
        } catch (Throwable t) {
            v = "unknown";
        }
        this.version = v;
    ...
    public void clearDebugCache() { debugCached = null; }
    ...
    public void saveResource(String resourcePath, boolean replace) {
        ...
        // .getResourceAsStream(resourcePath)} here. On NeoForge every
    ...
    static String toAnsi(String input) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (c == '§' && i + 1 < len) {
                ...
                if (ansi != null) { out.append(ansi); i++; translated = true; continue; }
            }
            out.append(c);
        }
    ...
    private static String ansiForCode(char code) {
        switch (code) {
            case '0': return "\u001B[30m"; case '1': return "\u001B[34m"; case '2': return "\u001B[32m";
            case '3': return "\u001B[36m"; case '4': return "\u001B[31m"; case '5': return "\u001B[35m";
            case '6': return "\u001B[33m"; case '7': return "\u001B[37m"; case '8': return "\u001B[90m";
            case '9': return "\u001B[94m"; case 'a': return "\u001B[92m"; case 'b': return "\u001B[96m";
            case 'c': return "\u001B[91m"; case 'd': return "\u001B[95m"; case 'e': return "\u001B[93m";
            case 'f': return "\u001B[97m"; case 'l': return "\u001B[1m";  case 'o': return "\u001B[3m";
            case 'n': return "\u001B[4m";  case 'm': return "\u001B[9m";  case 'r': return "\u001B[0m";
            default:  return null;
        }
    }

    @Override public void sendConsoleMessage(String message) { info(message); }
