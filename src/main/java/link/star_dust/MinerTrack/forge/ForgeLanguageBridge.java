...
/** Forge LanguageBridge. Loads language.yml via LanguageMerger. */
public class ForgeLanguageBridge implements LanguageBridge {
    ...
    public ForgeLanguageBridge(ForgeAdapter adapter) {
