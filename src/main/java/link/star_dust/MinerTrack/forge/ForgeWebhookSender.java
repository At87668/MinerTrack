...
/** Forge Webhook Sender. HTTP POST via HttpClient 5 on a daemon thread. */
public class ForgeWebhookSender implements WebhookEngine.Sender {
    private final PluginAdapter adapter;

    public ForgeWebhookSender(PluginAdapter adapter) {
