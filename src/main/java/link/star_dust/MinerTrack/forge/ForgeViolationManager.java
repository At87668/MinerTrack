...
public class ForgeViolationManager implements ViolationManagerBridge {
    ...
    @Override public void clearPlayerState(UUID pid) {
        ...
        ForgeDetectionBridge bridge = ForgeDetectionBridge.getActive();
        if (bridge != null) {
    ...
    @Override public UUID resolvePlayerId(String name) {
        ...
        try {
            ...
            Object pm = ForgeReflection.callMigrated(server, "getPlayerList", "getPlayerManager", ForgeReflection.NO_PARAMS, ForgeReflection.NO_ARGS);
            if (pm == null) return null;
            Object player = ForgeReflection.call(pm, "getPlayerByName", new Class<?>[]{String.class}, new Object[]{name});
