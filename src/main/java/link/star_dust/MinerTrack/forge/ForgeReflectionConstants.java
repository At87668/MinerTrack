...
final class ForgeReflectionConstants {
    ...
    // ==================================================================
    // Class-name fallback  (mojang/named → SRG/MCP for production servers)
    //
    // Forge 1.18.2 may use MCP names in production. This map gives
    // ForgeReflection.forName() a fallback when the mojang name fails.
    // On Mojang-mapped Forge (1.19.3+) the mojang name IS the runtime
    // name, so this map is unused.
    // ==================================================================
